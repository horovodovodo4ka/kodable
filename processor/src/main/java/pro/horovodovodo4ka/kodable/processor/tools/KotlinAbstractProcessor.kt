package pro.horovodovodo4ka.kodable.processor.tools
...
abstract class KotlinAbstractProcessor : AbstractProcessor(), KotlinProcessingEnvironment {
    ...
    override fun getCompletions(element: Element?, annotation: AnnotationMirror?, member: ExecutableElement?, userText: String?): Iterable<Completion> =
